# Univariate multi-step Encoder-Decoder CNN-LSTM for 
...
def build_model(train, n_input):
    ...
    # Reshape the output into [samples, timesteps, features]
...
summarize_scores('Encoder-Decoder CNN-LSTM', score, scores)

# Plot the scores
days = ['sun', 'mon', 'tue', 'wed', 'thr', 'fri', 'sat']
plt.plot(days, scores, marker = 'o', label = 'Encoder-Decoder CNN-LSTM')
plt.show()
