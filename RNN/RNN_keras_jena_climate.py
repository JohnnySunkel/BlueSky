...
data_dir = 'C:/Users/Julie/jena_climate/jena_climate_2009_2016.csv'
...
# Plot the temperature over the full temproal range of the dataset
temp = float_data[:, 1]
...
# Establish a non machine learning baseline for the problem
# using the MAE metric: np.mean(np.abs(preds - targets))
...
# Establish a machine learning baseline with a simple 
...
# Train and evaluate a GRU-based model using reversed sequences
...
# Train and evaluate a bidirectional GRU-based model
model = Sequential()
model.add(layers.Bidirectional(
    layers.GRU(32), input_shape = (None, float_data.shape[-1])))
model.add(layers.Dense(1))

model.compile(optimzer = RMSprop(),
              loss = 'mae')
