# Build a HMM model to recognize spoken words
...
def build_arg_parser():
    parser = argparse.ArgumentParser(
        description = 'Trains the HMM-based speech recognition system')
...
class ModelHMM(object):
    def __init__(self, num_components = 4, num_iter = 1000):
        ...
        # Initialize the variable that will store the models 
        # for each word
        self.models = []
    ...
    # 'training data' is a 2D numpy array where each row 
    # is 13-dimensional
...
# Define a function to build a model for each word in the
# training dataset        
...
# Define a function to run tests on the test dataset
def run_tests(test_files):
    ...
    for test_file in test_files:
        ...
        # Define the variables to store the maximum score and
        # the output label
        max_score = -float('inf')
        output_label = None
        ...
        for item in speech_models:
            ...
            # Evaluate the score and compare against the 
            # maximum score
...
# Define the main function and get the input folder from
# the input parameter
