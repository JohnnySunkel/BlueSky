...
# Define a class to handle all object tracking related functionality
class ObjectTracker(object):
    def __init__(self, scaling_factor = 0.5):
        ...
        # Set the scaling factor for the captured frame
    ...
    # Define a function to start tracking the object
    def start_tracking(self):
        ...
        while True:
            ...
            # Convert the frame from RGB to HSV colorspace
            ...
            if self.selection:
                ...
                # Compute the histogram of the region of interest
                # in the HSV image using the mask
            ...
            # Check if the system is in "tracking" mode
            if self.tracking_state == 1:
                ...
                # Compute bitwise AND between the histogram
                # back projection and the mask
                hsv_backproj &= mask
                ...
                # Apply the CAMShift algorithm to the 
                # back projected histogram
