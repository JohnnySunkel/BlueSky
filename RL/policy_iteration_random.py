...
# the agent will go in the desired direction with probability 0.5
# and a random direction a' != a with probability 0.5 / 3
if __name__ == '__main__':
    ...
    # repeat until convergence - will break out of the loop
