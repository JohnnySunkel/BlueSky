...
from monte_carlo_random import random_action, play_game, SMALL_ENOUGH
from monte_carlo_random import GAMMA, ALL_POSSIBLE_ACTIONS
...
if __name__ == '__main__':
    ...
    # MC method won't get this exactly, but should be close
